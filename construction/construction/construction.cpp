...
const Construction operator*(unsigned int n, Construction const& a)
{
	...
	//for (size_t i = a.contenu.size(); i--;) {
	//	for (size_t j = 0; j < a.contenu[i].size(); j++) {
	//		for (size_t k = 0; k < a.contenu[i][j].size(); k++) {
	//			b.contenu[i][j][k] = a.contenu[i][j][k];
	//		}
	//	}
	//}
